            ...
            <div className="flex items-center justify-between px-6 py-5">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="rounded-xl border border-slate-300 bg-white px-8 py-3 font-medium text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
