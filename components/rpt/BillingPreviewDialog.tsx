            ...
            <div className="absolute inset-6 flex flex-col rounded-lg bg-white shadow-xl">
                ...
                <div className="flex-1 overflow-auto bg-slate-300 p-8">
                    ...
                    <div
                        id="print-area"
                        ref={printRef}
                        className="print-paper mx-auto bg-white p-10 shadow-lg"
                    >
                        ...
                        <div className="print-section flex items-center justify-between">
                        ...
                        <div className="print-section mt-8 text-[12px]">
                        ...
                        <div className="print-section border-t border-black text-[12px]">
                        ...
                        <div className="print-section mt-8 flex justify-between gap-8">
                        ...
                        <div className="print-signatures mt-16 grid grid-cols-3 gap-12 text-center text-[12px]">
                        ...
                        <div className="print-notes mt-8 rounded border border-black p-4 text-[11.5px]">
                            ...
                            <div className="ml-5 flex gap-16">
                                ...
                                <span>
                                    • 1st Qtr - not later than March 31st
                                </span>

                                <span>
                                    • 2nd Qtr - not later than June 30th
                                </span>
                            ...
                            <div className="ml-5 flex gap-16">
                                ...
                                <span>
                                    • 3rd Qtr - not later than September 30th
                                </span>

                                <span>
                                    • 4th Qtr - not later than December 31st
                                </span>
                        ...
                        <div className="print-footer mt-10 border-t pt-3 text-center text-[10px] text-gray-600">
