...
try {
    ...
    /* =====================================================
       ...
       COLLECTOR:
       users.id = dipp_transactions.collector_id

       ENCODED BY:
       users.id = dipp_transactions.encoded_by
    ===================================================== */
        ...
        await pool.query(
            ...
            SELECT
                ...
                /* =========================================
                   ...
                   encoded_by keeps the UUID.
                   encoded_by_name contains the user's
                   full_name for display and printing.
                ========================================= */
